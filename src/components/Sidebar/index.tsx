...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    ...
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className={`flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5 text-white-100 ${style.logo}`}>
        <Link href="/">
          MO Grocery
        </Link>
                    ...
                    <React.Fragment>
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <Link
                              href="/forms/all-product"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white  ${pathname === "/forms/All-Product" &&
                              "text-white"
                              } `}
                            >
                              All Product
                          ...
                          <li>
                            <Link
                              href="/forms/add-product"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${pathname === "/forms/Add-Product" &&
                                "text-white"
                                } `}
                            >
                              Add Product
